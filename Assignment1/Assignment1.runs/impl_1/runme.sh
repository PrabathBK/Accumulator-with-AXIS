...
HD_PWD='D:/DVCON/VHDL/RTL/projects/Assigmnet_1/Assigmnet_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log count_sum.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source count_sum.tcl -notrace
