...
HD_PWD='D:/DVCON/VHDL/RTL/projects/Assigmnet_1/Assigmnet_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log count_sum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source count_sum.tcl
